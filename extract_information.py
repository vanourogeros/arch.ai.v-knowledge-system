...
def query_data(query):
    ...
    return as_output, retriever_output, source
...
with gr.Blocks(theme=Base(), title="Question Answering App using Vector Search + RAG") as demo:
    ...
    with gr.Column():
        ...
        source = gr.Textbox(lines=1, max_lines=10, label="Source")

# Call query_data function upon clicking the Submit button

    button.click(query_data, textbox, outputs=[output1, output2, source])
